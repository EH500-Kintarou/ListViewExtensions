...
namespace Sample.Models
{
	public class Model : NotificationObject
	{
		...
		public SortableObservableCollection<Person> People { get; } = new SortableObservableCollection<Person>();
		...
		{
			People.AddRange(Enumerable.Repeat<object>(null, count).Select(p => array[random.Next(array.Length)]));
